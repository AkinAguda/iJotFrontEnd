...
export interface CollectionType {
  id: string; notes: Notes; order: string;
}
...
const IndexedDB = (): {put: (id: string, notes: Notes, order: string) => Promise<string>;
getNotes: (id: any) => Promise<CollectionType>, getNote: (uid: string, id: string) => Promise<DBNoteType>} => {
  return {
